...
class BaseComponent implements IPageComponent {
	...
	public function registerNavigationPrevention():Void {
		app.state.PageNavigator.instance.addBeforeNavigateHook(function() {
	...
	function set_id(v:String):String
		return _id = v;
	...
	function get_props():Dynamic
		return _props;

	function set_props(v:Dynamic):Dynamic
		return _props = v;
