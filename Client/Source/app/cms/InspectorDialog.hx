...
import app.cms.components.ButtonComponent;
import app.state.PageNavigator;
...
class InspectorDialog extends Dialog {
	...
	function addButtonInspector(editorComp:EditorComponent):Void {
		...
		PageNavigator.instance.cmsManager.listPages(function(response:ListPagesResponse) {
