...
class RegisterDialog extends Dialog {
	...
	public function new() {
		...
		if (registerBtn != null)
			registerBtn.onClick = function(_) doRegister();
		if (backToLoginBtn != null)
			backToLoginBtn.onClick = function(_) goBackToLogin();
	...
	function doRegister():Void {
		...
		if (registeringRow != null)
			registeringRow.hidden = false;
