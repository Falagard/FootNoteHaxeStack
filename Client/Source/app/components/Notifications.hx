...
class Notifications {
	...
	public static inline function success(msg:String, duration:Int = 4000)
		show(msg, "success", duration);

	public static inline function error(msg:String, duration:Int = 4000)
		show(msg, "error", duration);

	public static inline function info(msg:String, duration:Int = 4000)
		show(msg, "info", duration);

	public static inline function warning(msg:String, duration:Int = 4000)
