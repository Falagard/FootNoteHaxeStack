...
class MenuListComponent extends BaseComponent {
    ...
    public function new(?id:String) {
        super(id, "menulist");
        if (_props.menuId == null) _props.menuId = 0;
        if (_props.showTitle == null) _props.showTitle = true;
        if (_props.layout == null) _props.layout = "vertical"; // vertical, horizontal, grid
    ...
    override public function render():Component {
        ...
        table.onClick = function(_) {
            ...
            if (item != null && item.menuId != null) {
                ...
                if (onEditMenu != null) onEditMenu(item.menuId);
            }
        };
